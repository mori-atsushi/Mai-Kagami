...
SpeedOption::SpeedOption(DecorationItem *decorationItem, Songs *songs, Touch *touch) {
	...
	speed[0] = new MyDrawText(decorationItem, "スピード", WIDTH * 0.72, height, 0, 30);
...
PartOption::PartOption(DecorationItem *decorationItem, Songs *songs, Touch *touch) {
	...
	float height = BUTTON_POS + BUTTON_INTERVAL / 2;
	part[0] = new MyDrawText(decorationItem, "始め：", WIDTH * 0.67, height, 0, 30);
	part[1] = new MyDrawText(decorationItem, "", WIDTH * 0.79, height, 0, 30, "Yellow");
	part[2] = new MyDrawText(decorationItem, "終わり：", WIDTH * 0.67, height + BUTTON_INTERVAL * 2, 0, 30);
	...
	caution = new MyDrawText(decorationItem, "区間が正しく設定されていません!", WIDTH, HEIGHT * 0.75, ALIGNMENT_RIGHT, 30, "White");
}
...
SpeedPop::SpeedPop(DecorationItem *decorationItem, Songs *songs, Touch *touch) {
	...
	button = new CircleButton2(decorationItem, touch, "決定", 4);
	text = new MyDrawText(decorationItem, "- 速度設定 -", WIDTH * 0.95, HEIGHT * 0.45, 2, 40);
}
...
PartPop::PartPop(DecorationItem *decorationItem, Songs *songs, Touch *touch) {
	...
	button = new CircleButton2(decorationItem, touch, "決定", 4);
	text = new MyDrawText(decorationItem, "- 区間設定 -", WIDTH * 0.95, HEIGHT * 0.45, 2, 40);
}
