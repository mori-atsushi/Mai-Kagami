...
ThroughFinish::ThroughFinish(DecorationItem *decorationItem, Songs *songs, Touch *touch, Result *result) {
	...
	button[0] = new CircleButton(decorationItem, touch, "‚à‚¤ˆê“x", 1, WIDTH * 0.75, "Blue");
	button[1] = new CircleButton(decorationItem, touch, "•”•ª—ûK", 2, WIDTH * 0.75, "Blue");
	button[2] = new CircleButton(decorationItem, touch, "‹È‘I‘ð‰æ–Ê", 3, WIDTH * 0.75, "Blue");
}
